...
namespace BlazorClockCanvasComponent
{
    public static class ClockSettings
    {
        ...
        public static TextBaseline Clock_Numbers_TextBaseline { get; set; } = TextBaseline.Middle;
        public static TextAlign Clock_Numbers_TextAlign { get; set; } = TextAlign.Center;
