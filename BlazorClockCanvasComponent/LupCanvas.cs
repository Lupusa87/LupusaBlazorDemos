...
namespace BlazorClockCanvasComponent
{
    public class LupCanvas
    {
        ...
        {
            BCCCJsInterop.Add_Canvas(FgCanvasID, BgCanvasID, TopCanvasID);
        }

        public void Remove_Canvas()
        {
            BCCCJsInterop.Remove_Canvas(FgCanvasID);
        }

        public void Log_Canvas_Array()
        {
            BCCCJsInterop.Log_Canvas_Array();
        }
        ...
        public void RenderToUI()
        {
            ...
            {
                BCCCJsInterop.Render_To_UI(canvasID);
            }
            else
            {
        ...
        public void Translate(float x, float y)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Translate(canvasID, x, y);
            }
            else
            {
        ...
        public void Move_To(float x, float y)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Move_To(canvasID, x, y);
            }
            else
            {
        ...
        public void Line_To(float x, float y)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Line_To(canvasID, x, y);
            }
            else
            {
        ...
        public void SetTransform()
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Set_Transform(canvasID);
            }
            else
            {
        ...
        public void ClearCanvas()
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Clear_Canvas(canvasID);
            }
            else
            {
                SB_Append(" ctx1.setTransform(1, 0, 0, 1, 0, 0);");
        ...
        public void DrawFullSizeRect(string color)
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Draw_Full_Size_Rect(canvasID, color);
            }
            else
            {
        ...
        public void Begin_Path()
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Begin_Path(canvasID);
            }
            else
            {
                SB_Append("ctx1.beginPath();");
        ...
        public void Rotate(float angle)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Rotate(canvasID, angle);
            }
            else
            {
        ...
        public void Fill_Text(TransferFillTextParameters transferFillTextParameters)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Fill_Text(canvasID, transferFillTextParameters);
            }
            else
            {
        ...
        public void StrokeRect(TransferRectParameters transferRectParameters)
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Stroke_Rect(canvasID, transferRectParameters);
            }
            else
            {
        ...
        public void SaveState()
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Save_State(canvasID);
            }
            else
            {
        ...
        public void RestoreState()
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Restore_State(canvasID);
            }
            else
            {
        ...
        public void CreateRadialGradient(TransferRadialGradientParameters transferRadialGradientParameters)
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Create_Radial_Gradient(canvasID, transferRadialGradientParameters);
            }
            else
            { 
        ...
        public void GradientAddColorStop(double stop, string color)
        {
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Gradient_Add_Color_Stop((float)stop, color);
            }
            else
            {
        ...
        public void GradientSetStokeOrFillStyle(bool StrokeOrFill)
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Gradient_Set_Stoke_Or_Fill_Style(canvasID, StrokeOrFill);
            }
            else
            {
                if (StrokeOrFill)
        ...
        public void Draw_Image(string imgName, TransferImageParameters transferImageParameters)
        {
            ...
            if (_JsInteropExecutionMode == 0)
            {
                BCCCJsInterop.Draw_Image(canvasID, imgName, transferImageParameters);
            }
            else
            {
        ...
        {
          return await BCCCJsInterop.Preload_Image();
        }
        ...
        {
            BCCCJsInterop.Execute_Dynamic_Script(sb.ToString());
            SB_Clear();
        }
